...
const AboutUs = () => {
  return (
    <main className="mx-auto  w-full items-center justify-center ">
      {/* Header Section */}
      <header className="bg-white gap-36 py-20 h-80 flex justify-center">
        ...
        <div className=" flex justify-center py-8 text-te2">
        <p className="text-te2 text-gray-600 ">
      ...
      {/* Mission Section */}
      <section className="relative bg-white dark:bg-rgb-2-6-23 text-theme-blue dark:text-white py-20">
        {/* Container */}
      ...
      {/* Footer Section */}
      <footer className="bg-black text-white py-28 text-center">
        <h2 className="text-h2 font-semibold ">Sign up for all the Future Updates</h2>
        <p className="mt-16 items-center">Our mission is to streamline the architectural drawing process and elevate the quality of <br></br> construction documents through cutting-edge technology.</p>
        <div className="">
        <input
          type="email"
          placeholder="Enter your Email Address.... "
          className="p-3 mt-16 rounded-lg w-96 "
        />
        <button className="bg-gray-800 p-3 rounded-lg ">Subscribe</button>
        </div>
      </footer>
    </main>
  );
