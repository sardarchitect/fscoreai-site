const PrivacyPolicy = () => {
  return (
    ...
    <section className="mb-6">
      ...
      <p className="text-sm text-gray-600 mb-2">Last updated: January 06, 2025</p>
    ...
    <section className="mb-6">
      ...
      <ul className="list-disc list-inside space-y-2 mt-2">
        ...
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Fscore AI LLC, 1 Washington Mall, #1264, Boston, MA 02108.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Fscore AI, accessible from <a href="https://www.fscore.ai" className="text-blue-600 underline">www.fscore.ai</a>.
        </li>
        <li>
      ...
      <section className="mb-6">
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">Waiver</h3>
        <p>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            By email: <a href="mailto:support@fscore.ai" className="text-blue-600 underline">support@fscore.ai</a>
          </li>
        </ul>
