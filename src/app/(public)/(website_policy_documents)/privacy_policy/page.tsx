...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">Last updated: January 06, 2025</p>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li><strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Fscore AI LLC, 1 Washington Mall, #1264, Boston, MA 02108.</li>
        ...
        <li><strong>Website:</strong> Refers to Fscore AI, accessible from <a href="https://www.fscore.ai" className="text-blue-500 hover:underline">www.fscore.ai</a>.</li>
      ...
      <section className="mb-6">
        ...
        <h3 className="text-lg font-medium mb-2">We use both Session and Persistent Cookies for the purposes set out below:</h3>
        <ul className="list-disc ml-6 mb-4">
          <li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>To provide You with news, special offers and general
              information:</strong> About other goods, services, and events
...
You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any personal information that You have provided to Us.        </p>
      ...
      <section className="mb-6">
        ...
        <div className="mb-4">
          <h3 className="font-semibold mb-2">Other legal requirements</h3>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>By email: support@fscore.ai</li>
        </ul>
      </section>
    </div>
  );
...
//         <p className="mb-4">
//           Welcome to <strong>fscore.ai</strong>! We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website.
//         </p>
...
//           <li className="mb-2">Any other information you voluntarily provide to us</li>
//         </ul>
...
//         </p>
//         <ul className="list-disc pl-5 mb-4">
//           <li className="mb-2">To provide, operate, and maintain our website</li>
//           <li className="mb-2">To improve, personalize, and expand our website</li>
//           <li className="mb-2">To communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes</li>
//           <li className="mb-2">To process your transactions</li>
//           <li className="mb-2">To find and prevent fraud</li>
//         </ul>
  
//         <h2 className="text-2xl font-semibold mb-4">3. Sharing Your Information</h2>
//         <p className="mb-4">
//           We do not share your personal information with any third parties without your consent, except in the following circumstances:
//         </p>
//         <ul className="list-disc pl-5 mb-4">
//           <li className="mb-2">With service providers who assist us in operating our website and conducting our business</li>
//           <li className="mb-2">When we believe disclosure is necessary and appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property, or safety</li>
//         </ul>
  
//         <h2 className="text-2xl font-semibold mb-4">4. Your Rights</h2>
//         <p className="mb-4">
//           You have the right to access, update, and delete your personal information. If you would like to exercise any of these rights, please contact us at support@fscore.ai.
//         </p>
...
//         </p>
//         <ul className="list-disc pl-5 mb-4">
//           <li className="mb-2">By email: support@fscore.ai</li>
//         </ul>
//       </div>
//   )
// }
