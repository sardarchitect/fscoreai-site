...
const StackedCards = () => {
  ...
  const getTransformStyle = (index, activeIndex, step) => {
    ...
    return "translate(-50%, -50%) rotate(-15deg)"; // Default position for other cards
  };
              ...
              {cards.map((card, index) => (
                <div
                  ...
                  {(card.description || card.title) ?
                    (<div className={`w-[389px] h-[330px] p-14 bg-[#FFFFFF] rounded-md shadow-2xl border-2 backdrop-blur-[30px] flex-col justify-center items-center gap-2.5`}
                    >
