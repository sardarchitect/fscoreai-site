            ...
            >
              {testimonials.map((testimonial, index) => {
                ...
                return (
                  <motion.div
                    key={testimonial.id}
                    className={`bg-white shadow-lg  rounded-lg p-8 text-start w-96 cursor-pointer scroll-smooth  flex-none transition-transform duration-300 transform ${isCenter
