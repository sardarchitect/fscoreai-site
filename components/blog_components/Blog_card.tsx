  ...
  return (
    <div className="max-w-lg mx-auto">
      <div className="bg-blue-200 shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
        ...
        <div className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center items-end inline-flex  cursor-pointer"
        onClick={() => {
